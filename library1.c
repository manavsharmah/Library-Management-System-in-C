...
#define FILE_NAME  "miniproject.bin"
...
typedef struct// to call in program
{
    ...
    char studentName[MAX_STUDENT_NAME];// declare the charecter data type
    char studentAddr[MAX_STUDENT_ADDRESS];// declare the charecter data type
...
void init()
{
    FILE *fp = NULL;
    int status = 0;
    const char defaultUsername[] ="miniproject\n";
    const char defaultPassword[] ="miniproject\n";
    sFileHeader fileHeaderInfo = {0};
